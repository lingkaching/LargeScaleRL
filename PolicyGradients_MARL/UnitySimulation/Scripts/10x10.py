...
def main():
    modelPath = '../../Models/10x10.model'
    env_name = './ExecutiveEnv/10x10/Unity Environment'
    pathFile = '../PathFile/10_20_l5_DC_psdd_ex0_run0.txt'
    
    num_of_agents = 20    
    GOALS = [98, 91, 92, 99, 97, 96, 95, 98, 99, 99, 3, 3, 1, 6, 5, 1, 0, 4, 5, 9] 
